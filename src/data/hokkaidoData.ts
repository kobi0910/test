...
export interface SeasonalPair {
  summerImage: string;
  summerFallback: string;
  summerTitle: string;
  summerDesc: string;
  winterImage: string;
  winterFallback: string;
  winterTitle: string;
  winterDesc: string;
}
...
export const HOKKAIDO_REGIONS: RegionData[] = [
  {
    id: 'otaru',
    nameJP: '小樽',
    nameRomaji: 'OTARU',
    ...
    seasonalPair: {
      ...
      summerFallback: 'https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&w=1600&q=80',
      summerTitle: '夏日綠意運河巡航',
      summerDesc: '陽光穿透微風，運河兩岸綠藤鋪展，巡航舟船緩緩劃過明淨水面。',
      winterImage: '/images/otaru.png',
      winterFallback: 'https://images.unsplash.com/photo-1542051841857-5f90071e7989?auto=format&fit=crop&w=1600&q=80',
  ...
  },
  {
    ...
    hotspots: [
      ...
      },
      {
        ...
        y: 75,
        title: '金森紅磚倉庫群',
        subtitle: '海邊明治開港時期港灣倉庫',
        description: '紅磚壁面沉澱著百年海風鹹味，如今內部匯聚精緻餐廳、禮品店與甜點工坊。',
        exif: '35mm | f/1.4 | 1/80s | ISO 1200',
        tag: '浪漫港灣'
      }
    ],
    seasonalPair: {
      summerImage: 'https://images.unsplash.com/photo-1528164344705-475426879e0d?auto=format&fit=crop&w=1600&q=80',
      summerFallback: 'https://images.unsplash.com/photo-1528164344705-475426879e0d?auto=format&fit=crop&w=1600&q=80',
      summerTitle: '夏日斜坡綠蔭與湛藍港灣',
      summerDesc: '八幡坂石板路直通藍天與海面，石造教堂在清爽海風中鳴響報時鐘聲。',
      winterImage: '/images/hakodate.png',
      winterFallback: 'https://images.unsplash.com/photo-1578637387939-43c525550085?auto=format&fit=crop&w=1600&q=80',
    ...
    attractions: [
      ...
      },
      {
        ...
        description: '日本第一座西洋式星形要塞城堡，由蘭學者武田斐三郎設計。春天1600株櫻花綻放成星形粉紅絨毯，冬日則積雪成白銀五角星。',
        image: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&w=1600&q=80',
        fallbackImage: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&w=1600&q=80',
      ...
      },
      {
        id: 'hachimanzaka',
        nameJP: '八幡坂與元町教堂區',
        nameEN: 'Hachimanzaka Slope',
        tagline: '直通大海的坡道，和洋折衷的歷史建築集散地',
        description: '經常出現在影視作品中的經典坡道。石板路兩旁林立著銀杏與歷史洋館，路底即是停泊著摩周丸船隻的港灣水面。',
        image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=1600&q=80',
        fallbackImage: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=1600&q=80',
        exif: '50mm f/1.8 | 1/320s | ISO 100',
        bestTime: '冬季落日黃昏點燈時分',
        gourmetNote: '元町茶寮的抹茶小豆芭菲。',
        secretTip: '由坂頂向下拍攝，能將坡道、行道樹與遠處艦艇同時構圖入鏡。'
      }
    ]
  },
  {
    ...
    hotspots: [
      ...
      },
      {
        ...
        y: 70,
        title: '冰雪雕塑燈光秀',
        subtitle: '世界頂級冰雕藝術家年度會集',
        description: '每年2月初吸引世界數百萬遊客，巨大的城堡與動漫雕像在專業3D投影下展現光影奇蹟。',
        exif: '50mm | f/1.4 | 1/125s | ISO 400',
        tag: '冬日祭典'
      }
    ],
    seasonalPair: {
      summerImage: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&w=1600&q=80',
      summerFallback: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&w=1600&q=80',
      summerTitle: '夏日大通公園啤酒花園',
      summerDesc: '紫丁香花開滿公園，露天啤酒節傳出爽朗笑聲，微風帶來清涼山風。',
      winterImage: '/images/sapporo.png',
      winterFallback: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&w=1600&q=80',
    ...
    attractions: [
      ...
      },
      {
        ...
        tagline: '美國開拓時代風格木造建築，百年鐘聲迴盪',
        description: '建於1878年，原為舊札幌農學校演武場。白色木造外牆與紅色屋頂在雪地中顯得格外古樸可愛。至今鐘聲仍準時鳴響。',
        image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=1600&q=80',
        fallbackImage: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=1600&q=80',
        exif: '35mm f/2.0 | 1/200s | ISO 160',
        bestTime: '整點鐘聲鳴響時分',
        gourmetNote: '周邊「味之時計台」濃郁味噌拉麵。',
        secretTip: '對面商業大樓2樓露台是拍攝時計台全景的隱藏神位。'
      },
      {
        id: 'susukino',
        nameJP: '薄野不夜城',
        nameEN: 'Susukino Entertainment District',
        tagline: '霓虹交織的北方不夜街，深夜拉麵與成吉思汗烤肉',
        description: '與東京歌舞伎町齊名的北方娛樂街。巨大的NIKKA威士忌霓虹招牌是其標誌。深夜的拉麵橫丁熱氣騰騰，撫慰無數旅人。',
        image: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&w=1600&q=80',
        fallbackImage: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&w=1600&q=80',
        exif: '50mm f/1.4 | 1/160s | ISO 1000',
        bestTime: '21:00 - 24:00 深夜熱鬧之際',
        gourmetNote: '「達摩」成吉思汗特選烤羊肉配冰鎮札幌啤酒。',
        secretTip: '札幌特殊的「締めパフェ」（夜間結尾芭菲）文化不可錯過。'
      }
    ]
  },
  {
    ...
    hotspots: [
      ...
      },
      {
        ...
        y: 35,
        title: '十勝岳連峰倒影',
        subtitle: '標高2000公尺級火山群背景',
        description: '雄渾的火山山脈頂端常年覆雪，與腳下溫柔色彩鮮明的農田形成剛柔並濟的強烈視覺對比。',
        exif: '100mm | f/5.6 | 1/640s | ISO 100',
        tag: '雄偉自然'
      }
    ],
    seasonalPair: {
      summerImage: '/images/furano.png',
      summerFallback: 'https://images.unsplash.com/photo-1534447677768-be436bb09401?auto=format&fit=crop&w=1600&q=80',
      summerTitle: '夏日七彩彩虹花丘',
      summerDesc: '濃郁紫羅蘭薰衣草香氣瀰漫，小麥田與花海交織成斑斕地毯。',
      winterImage: '/images/biei.png',
      winterFallback: 'https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&w=1600&q=80',
    ...
    attractions: [
      ...
      },
      {
        id: 'blue-pond',
        nameJP: '美瑛白金青池',
        nameEN: 'Shirogane Blue Pond',
        tagline: '神秘鈷藍色水面與枯落落葉松的仙境',
        description: '因十勝岳防災工程意外形成的池塘。水中含有氫氧化鋁膠體，光線散射下呈現神奇的水藍色，落葉松枯木挺立其中，空靈絕美。',
        image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1600&q=80',
        fallbackImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1600&q=80',
        exif: '24mm f/4.0 | 1/200s | ISO 200',
        bestTime: '無風陽光直射的正午時分（湖面藍得最純粹）',
        gourmetNote: '美瑛道之驛青池限定蘇打美瑛軟雪糕。',
        secretTip: '冬季夜間點燈，青池雪景在燈光投射下宛如潘朵拉星球。'
      },
      {
        id: 'biei-trees',
        nameJP: '美瑛名樹巡禮',
  ...
  },
  {
    ...
    hotspots: [
      ...
      },
      {
        ...
        title: '北極熊圓筒水槽',
        subtitle: '「行動展示」美學先驅',
        description: '透過半球型透明觀察罩，感受巨大白熊從頭頂躍入水中優雅划水的震撼視覺體驗。',
        exif: '24mm | f/1.8 | 1/500s | ISO 400',
        tag: '互動設計'
      }
    ],
    seasonalPair: {
      summerImage: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1600&q=80',
      summerFallback: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1600&q=80',
      summerTitle: '夏日大雪山旭岳高山植物花海',
      summerDesc: '姿見池映照火山噴氣孔蒸汽，高山植物在短期夏日里繁花盛開。',
      winterImage: '/images/shiretoko.png',
      winterFallback: 'https://images.unsplash.com/photo-1548199973-03cce0bbc87b?auto=format&fit=crop&w=1600&q=80',
    ...
    attractions: [
      ...
      },
      {
        ...
        nameJP: '大雪山旭岳',
        nameEN: 'Mount Asahi',
        tagline: '北海道最高峰（2291m），神靈遊玩之庭園',
        description: '愛努人稱之為「KAMUI MINTARA」（神靈遊玩的花園）。搭乘纜車可輕鬆到達姿見之池，沿途噴氣孔硫磺蒸汽繚繞，地形雄渾。',
        image: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=1600&q=80',
        fallbackImage: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=1600&q=80',
        exif: '24mm f/5.6 | 1/640s | ISO 100',
        bestTime: '秋季9月中旬（全日本最早紅葉勝地）',
        gourmetNote: '旭岳纜車姿見站的熱騰騰大雪山可樂餅。',
        secretTip: '繞行姿見池步道一圈約需1小時，路面多碎石建議穿著登山鞋。'
      },
      {
        id: 'ramen-village',
        nameJP: '旭川拉麵村',
        nameEN: 'Asahikawa Ramen Village',
        tagline: '豬骨與魚介雙湯頭，表面浮覆油脂的溫暖拉麵',
        description: '匯聚青葉、梅光軒等8家旭川名店。因應旭川極寒氣候，拉麵特別以豬骨魚介高湯搭配表面薄薄豬油層保溫，極具特色。',
        image: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?auto=format&fit=crop&w=1600&q=80',
        fallbackImage: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?auto=format&fit=crop&w=1600&q=80',
        exif: '35mm f/1.8 | 1/125s | ISO 500',
        bestTime: '午餐 11:30 - 13:00',
        gourmetNote: '傳統旭川正宗正油（醬油）拉麵。',
        secretTip: '拉麵村內設有小型的拉麵神社可供參拜與抽籤。'
      }
    ]
  },
  {
    ...
    hotspots: [
      ...
      },
      {
        ...
        y: 40,
        title: '知床連山與斷崖海岸',
        subtitle: '火山群直落海面的原生奇景',
        description: '從觀光船上仰望高達百公尺的陡峭斷崖，瀑布直接注入蔚藍海洋，氣勢磅礴。',
        exif: '50mm | f/5.6 | 1/500s | ISO 100',
        tag: '雄偉景觀'
      }
    ],
    seasonalPair: {
      summerImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1600&q=80',
      summerFallback: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1600&q=80',
      summerTitle: '夏日知床五湖翠綠高架木道',
      summerDesc: '原始森林簇擁著靜謐湖泊，湖面倒映著知床連山的巍峨綠姿。',
      winterImage: '/images/shiretoko.png',
      winterFallback: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1600&q=80',
    ...
    attractions: [
      ...
      },
      {
        id: 'ryuhyo-walk',
        nameJP: '鄂霍次克海流冰漫步',
        nameEN: 'Shiretoko Drift Ice Walk',
        tagline: '踏上浮動的海上冰原，挑戰浸泡冰冷大海',
        description: '每年僅有2月至3月可體驗的極致活動。穿著高保暖浮力防寒衣，在連綿至地平線的流冰上行走、躺臥，甚至跳入冰海漂浮。',
        image: 'https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&w=1600&q=80',
        fallbackImage: 'https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&w=1600&q=80',
        exif: '16mm f/5.6 | 1/1250s | ISO 100',
        bestTime: '日落前夕（流冰被染成金粉色）',
        gourmetNote: '宇登呂港口現燙新鮮鱈場蟹與鮭魚卵丼飯。',
        secretTip: '必須預約當地持照專業嚮導帶領體驗，極具安全保障。'
      },
      {
        id: 'kamuiwakka',
        nameJP: '神之水溫泉瀑布',
        nameEN: 'Kamuiwakka Falls',
        tagline: '整條河川即是天然硫磺溫泉，溯溪奇趣體驗',
        description: '從知床硫磺山噴出的溫泉水直接流入河川，使整條溪流成為暖洋洋的溫泉河。遊客可以赤腳或穿溯溪鞋沿著岩石向上攀登。',
        image: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1600&q=80',
        fallbackImage: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1600&q=80',
        exif: '35mm f/2.8 | 1/250s | ISO 200',
        bestTime: '夏季7月 - 8月溫暖午後',
        gourmetNote: '羅臼港現烤鹿肉串燒與海膽珍味。',
        secretTip: '水質呈強酸性，建議攜帶防滑鞋並維護生態環境。'
      }
    ]
  }
];
